                ...
                <nav className={`sidebarlist`}>
                    <ul style={{ listStyle: "none", padding: 0 }}>
                        ...
                        {role==='owner' && <><Link to="/business/dashboard" className={`sidebarNav`} >
                            ...
                            <i class="fa-solid fa-chart-simple"></i><p className={`list-element ${isSidebarOpen? "active": ""}`}>Dashboard</p>
                            </li>
                        </Link><hr className="m-0" /></>}
                        ...
                        <Link to="/calendar" className={`sidebarNav`} >
                            <li className={`listItems  ${isSidebarOpen? "": "active"} ${location.pathname === "/calendar" ? "sidebarSelected" : ""}`}>
                            <i className="fa-solid fa-calendar-check"></i><p className={`list-element ${isSidebarOpen? "active": ""}`}>Calendar</p>
                            </li>
                        </Link>

                        {role==='owner' && <><hr className="m-0" /><Link to="/business/rule-book" className={`sidebarNav`} >
